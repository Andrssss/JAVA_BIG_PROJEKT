...
public class Vectorr {
    ...
    void random()
    {
        float x_randomNumber = ThreadLocalRandom.current().nextInt(Palya.palyameret_x);
        float y_randomNumber = ThreadLocalRandom.current().nextInt(Palya.palyameret_y);
         x = floor(x_randomNumber % Palya.palyameret_x);
         y = floor(y_randomNumber % Palya.palyameret_y);
    }
    float hosszNegyzet()
    {
